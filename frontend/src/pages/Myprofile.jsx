...

{
  ...
  : <p className='text-3xl mt-4 text-neutral-800 font-medium'>{userData.name}</p>
}
...
{
  isedit ? <input className='bg-gray-50 max-w-60' type="text" value={userData.phone} onChange={e=> setUserData(prev=>({...prev,phone:e.target.value}))}/>
...
{
  isedit ?
  <button className='border border-[#5f6FFF] px-8 py-2 rounded-full hover:bg-[#5f6FFF] hover:text-white transition-all' onClick={updateUserProfileData}>Save info</button>
