      ...
      <div className='bg-white border-rounded text-sm max-h-[80vh] overflow-y-scroll min-h-[60vh]'>
        ...
        {appointments.map((item,index)=>(
          ...
          {item.cancelled ? <p className='text-red-400 text-sm font-medium'>Cancelled</p>
           : item.isCompleted?
           <p className='text-green-500 text-sm font-medium'>Completed</p> : <img onClick={()=>cancelAppointment(item._id)} className='w-10 cursor-pointer' src={assets.cancel_icon}/>}
